...
namespace Restaurante.DAO
{
    public class IngredienteRepository : BaseRepository<Ingrediente>, IIngredienteRepository
    {
        ...
        =>  await WhereAsPaginateListAsync(x =>
                ...
                && (precioMin > 0.0 ? (porPrecioVenta ? x.PrecioVenta >= precioMin : x.PrecioCompra >= precioMin) : true || precioMax > 0.0 ? (porPrecioVenta ? x.PrecioVenta <= precioMax : x.PrecioCompra >= precioMax) : true),
