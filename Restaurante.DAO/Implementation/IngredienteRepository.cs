...
namespace Restaurante.DAO
{
    public class IngredienteRepository : BaseRepository<Ingrediente>, IIngredienteRepository
    {
        ...
        =>  await WhereAsPaginateListAsync(x =>
                ...
                && (precioMin == 0.0 && precioMax == 0.0 ? true : (precioMin > 0.0 ? (porPrecioVenta.Value ? x.PrecioVenta >= precioMin : x.PrecioCompra >= precioMin) : true || precioMax > 0.0 ? (porPrecioVenta.Value ? x.PrecioVenta <= precioMax : x.PrecioCompra <= precioMax) : true)),
