      ...
      <div class="container">
        ...
        <div id="middle-left-content">
          <div id="learning-materials" class="rounded shadow">
            ...
            <a href="https://nx.dev/getting-started/tutorials/angular-monorepo-tutorial?utm_source=nx-project" target="_blank" rel="noreferrer" class="list-item-link">
              <svg
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build restaurante-v2
<span># Test</span>
nx test restaurante-v2
<span># Lint</span>
nx lint restaurante-v2
<span># Run them together!</span>
nx run-many -p restaurante-v2 -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project restaurante-v2</pre>
          </details>
